...
import { useMyEventTypes } from '@/hooks/eventTypes';
...
export function EventTypesContent() {
  ...
  const { data: eventTypes, isLoading } = useMyEventTypes(debouncedSearch, !authLoading && !!user);
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">My Event Types</h1>
            <Link
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              placeholder="Search your event types…"
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              {debouncedSearch ? (
                ...
                <>
                  ...
                  <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-4">Create your first event type to get started.</p>
                  <Link
                    href="/event-types/new"
