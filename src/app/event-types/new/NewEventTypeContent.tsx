...
import { useCreateEventType } from '@/hooks/eventTypes';
import type { ApiError } from '@/lib/api';

export function NewEventTypeContent() {
    ...
    <div className="flex flex-col lg:flex-row h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-lg mx-auto px-6 py-8">
          ...
          <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100 mb-6">New Event Type</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                placeholder="e.g. 2-Point Field Goal Made"
