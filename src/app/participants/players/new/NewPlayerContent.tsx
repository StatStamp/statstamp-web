      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-lg mx-auto px-6 py-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <Link href="/participants?tab=players" className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
              Teams &amp; Players
            </Link>
            <span className="text-zinc-300 dark:text-zinc-600">/</span>
            <span className="text-sm text-zinc-900 dark:text-zinc-100">New Player</span>
          </div>

          <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100 mb-6">New Player</h1>
